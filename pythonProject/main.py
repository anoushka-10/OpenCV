...
#pre-processing
# img=cv2.imread("modiji2.jpg")
# img2=cv2.resize(img,(540,480))
# # img3=cv2.rotate(img2,cv2.ROTATE_90_CLOCKWISE)
# # cv2.imshow("Image-resize",img2)
# # cv2.imshow("Image-rotate",img3)
...
# cv2.putText(img,"OPENCV",(200,100),cv2.FONT_HERSHEY_SIMPLEX,1,(255,255,255),2)
